CREATE PROCEDURE `dierenpension`.`update_shop_voorschotten` ()
BEGIN
  ...
  DECLARE facturen_cursor CURSOR FOR
    ...
    GROUP BY f.shop_id, f.voorschot_datum, f.voorschot_betaal_wijze, f.voorschot_bedrag, betaling_count
