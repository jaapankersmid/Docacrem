CREATE PROCEDURE `dierenpension`.`update_pension_reservering_voorschotten` ()
BEGIN
  ...
  DECLARE facturen_cursor CURSOR FOR
    ...
    GROUP BY f.factuur_id, f.voorschot_datum, f.voorschot_betaal_wijze, f.voorschot_bedrag, betaling_count
