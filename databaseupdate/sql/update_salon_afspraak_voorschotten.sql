CREATE PROCEDURE `dierenpension`.`update_salon_afspraak_voorschotten` ()
BEGIN
  ...
  DECLARE facturen_cursor CURSOR FOR
    ...
    GROUP BY f.salon_afspraak_id, f.voorschot_datum, f.voorschot_betaal_wijze, f.voorschot_bedrag, betaling_count
