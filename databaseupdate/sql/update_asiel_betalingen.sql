CREATE PROCEDURE `dierenpension`.`update_asiel_betalingen` ()
BEGIN
  ...
  DECLARE facturen_cursor CURSOR FOR
    ...
    GROUP BY f.asiel_factuur_id, f.betaal_datum, f.betaal_wijze, f.voorschot_bedrag, totaal_betaald_betalingen
